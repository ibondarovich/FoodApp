  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomSheet: BlocProvider(
        create: (context) => DetailedDishBloc(
          saveCartItemUseCase: appLocator.get<SaveCartItemUseCase>(),
        ),
        child: BlocBuilder<DetailedDishBloc, DetailedDishState>(
          builder: (BuildContext context, DetailedDishState state) {
            return AppButton(
              onTap: () {
                BlocProvider.of<DetailedDishBloc>(context).add(
                  OnSaveItemEvent(
                    dishModel: dishModel,
                  ),
                );
